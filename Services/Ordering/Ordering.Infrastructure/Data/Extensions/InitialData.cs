...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            Address address1 = Address.Of("fırat", "kazak", "firatkazak@gmail.com", "Kuşpınar mah No:52", "Turkey", "Denizli", "20100");
            Address address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            Payment payment1 = Payment.Of("fırat", "5555555555554444", "12/28", "355", 1);
            Payment payment2 = Payment.Of("john", "8885555555554444", "06/30", "222", 2);
